...
! function() {
    ...
    const b = e => parseInt(e, 10),
        ...
        Se = e => _(e.dom.childNodes, ke),
        Ne = c(Element.prototype.attachShadow) && c(Node.prototype.getRootNode) ? e => ke(e.dom.getRootNode()) : e => de(e) ? e : Te(e),
        Me = e => ke(e.dom.host),
        Oe = e => {
        ...
        tt = (e, t) => N(e.querySelectorAll(t), (e => et(ke(e)))),
        ...
        mt = (e, t) => pt(e).fold((() => ((e, t) => {
            for (let r = 0, o = e.length; r < o; ++r)
                if (!0 !== t(e[r]))
                    return !1;
            return !0
        })(Se(e), (e => mt(e, t)))), (e => ((e, t) => Ke(e, ht, (e => Ce(e, t))).isSome())(e, t))),
        yt = {
            id: "D1",
            wcag: "1.3.1",
            severity: it(),
            ...
            check: e => {
                const t = ke(e),
                    ...
                    o = N(r, (e => {
                        const t = W(_e(e));
                        return O(t, he("a"), (e => {
                            return !(ue(t = e) && (r = ut(t).replace(/[\u200B-\u200D\uFEFF]/g, ""), !lt(r)));
                            var t, r
            ...
            const t = (e => {
                const t = Te(e),
                    ...
                    a = M(o, ((e, t) => {
                        ...
                        return Mt(r).bind((r => {
                            const o = Ot(t, r);
                            return o.alpha > 0 ? w.some(Nt(e, o)) : w.none()
                        })).getOr(e)
                    }), _t(0, 0, 0, 0));
                return a.alpha < 1 ? Nt(a, _t(255, 255, 255, 1)) : a
            })(e);
            return ((e, t) => {
                const r = Dt(e, "color");
                return Mt(r).bind((r => {
                    const o = Ot(e, r),
                        a = o.alpha < 1 ? Nt(o, t) : o;
                    return w.some(a)
                }))
            })(e, t).map((e => {
                const r = St(t);
                return ((e, t) => (Math.max(e, t) + .05) / (Math.min(e, t) + .05))(St(e), r)
            }))
        },
        Wt = {
            id: "D5c",
        ...
        Zt = t => {
            const r = (e => {
                const t = (e => {
                    ...
                    o = V(e);
                return {
                    rules: N([yt, gt, vt, At, Tt, $t, Gt, Wt, Pt, jt, Bt, Vt, Ft, zt, Ut, Jt, Xt, Kt], (e => !D(t, e.id.toUpperCase()) && D(e.levels, r) && D(e.htmlversions, o))),
    ...
    const cr = ({ issue: e, summaryLabel: t }, r, o, a, n, i) => {
        ...
        Or = (e, t) => {
            const r = ar(Sr(t), X((o = "a11y.i1.repair.info",
            ...
            const t = U(e),
                r = {
                    ...
                    I1: w.some({
                        ...
                        shouldDisableRepair: t ? w.some(Nr) : w.none(),
    ...
    tinymce.PluginManager.requireLangPack("a11ychecker", "ar,bg_BG,ca,cs,da,de,el,es,eu,fa,fi,fr_FR,he_IL,hi,hr,hu_HU,id,it,ja,kk,ko_KR,ms,nb_NO,nl,pl,pt_PT,pt_BR,ro,ru,sk,sl_SI,sv_SE,th_TH,tr,uk,vi,zh_TW,zh_CN"),
        tinymce.PluginManager.add("a11ychecker", ((e, t) => {
            if (((e, t) => !!e && -1 === ((e, t) => {
                    ...
                    return 0 !== a ? a : 0
                })((e => x((e => [e.majorVersion, e.minorVersion].join(".").split(".").slice(0, 3).join("."))(e)))(e), x(t)))(tinymce, "6.8.0"))
                return console.error('The "a11ychecker" plugin requires at least version 6.8.0 of TinyMCE.'), {};
            ((e, t) => {
            ...
            const r = Zt(e),
                ...
                n = Wr(e, r);
            return e.on("init", (() => {
                const t = "a11ychecker/css/annotations.css";
                if (tinymce.Resource.has(t)) {
                    const r = tinymce.Resource.get(t);
                    e.dom.styleSheetLoader.loadRawCss(t, r)
                } else
                    e.dom.loadCSS(a)
            })), {
