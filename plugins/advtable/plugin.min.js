    ...
    const er = e => Yn(e).edge(e),
            ...
            const o = e[0],
                n = ((e, n) => {
                    for (let n = 0, s = e.length; n < s; n++)
                        if (r = e[n], !t(o.element, r.element))
                            return w.some(n);
                    var r;
                    return w.none()
                })(e);
                    ...
                    if (!1 === o[r][s]) {
                        ...
                        return ((e, t, n, r) => {
                            for (let s = e; s < e + n; s++)
                                for (let e = t; e < t + r; e++)
                                    o[s][e] = !0
                        })(r, s, m.rowspan, m.colspan), [(l = n.element,
                            c = m.rowspan,
                            i = m.colspan,
                            a = n.isNew, {
                                element: l,
        ...
        ss = e => {
            const t = (e => w.from(e.options.get("table_clone_elements")))(e),
                ...
                s = (e, t, o, n) => {
                    const { cols: r, rows: s } = Rt(e), l = j(s, (e => e.section)), c = N(l, (e => j(e, (e => {
                ...
                l = (e, t, o, n) => {
                    const { cols: r, rows: s } = Rt(e), l = s[t].cells, c = N(l, (e => {
                        const t = e.element;
                        ...
                        const t = j(e.zippedCells, (e => {
                            ...
                            r = z(t, (e => {
                                ...
                                if (i(t))
                                    return N(e, (e => e.cell)); {
                                    const { pass: t, fail: r } = L(e, (e => e.cell.isLocked)), s = F(r, ((e, t) => {
                ...
                d = l,
                h = (e, t, o, n, r) => {
                    const { cols: s, rows: l } = Rt(e), c = l.slice(0, t), i = [...s, ...l.slice(t, o + 1)];
                    return {
                        beforeRows: c,
