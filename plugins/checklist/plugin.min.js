...
! function() {
    ...
    const k = t => t.dom.nodeName.toLowerCase(),
        ...
        E = t => O(t, "class"),
        D = (t, e) => ((t, e, o) => {
            const n = O(t, e).concat([o]);
            return T(t, e, n.join(" ")), !0
        })(t, "class", e),
        M = (t, e) => ((t, e, o) => {
            const n = p(O(t, e), (t => t !== o));
            return n.length > 0 ? T(t, e, n.join(" ")) : C(t, e), !1
        })(t, "class", e),
        j = (t, e) => {
            A(t) ? t.dom.classList.add(e) : D(t, e)
        },
        B = t => {
            0 === (A(t) ? t.dom.classList : E(t)).length && C(t, "class")
        },
        P = (t, e) => {
            A(t) ? t.dom.classList.remove(e) : M(t, e),
                B(t)
        },
        I = (t, e) => A(t) && t.dom.classList.contains(e),
        U = t => {
            if (null == t)
        ...
        X = t => u.from(t.dom.parentNode).map(R),
        $ = t => g(t.dom.childNodes, R),
        z = t => ((t, e) => {
            const o = t.dom.childNodes;
            return u.from(o[0]).map(R)
        })(t),
        F = c(Element.prototype.attachShadow) && c(Node.prototype.getRootNode) ? t => R(t.dom.getRootNode()) : t => b(t) ? t : R(t.dom.ownerDocument),
        K = t => R(t.dom.host),
        Y = t => {
            const e = L(t) ? t.dom.parentNode : t.dom;
            if (null == e || null === e.ownerDocument)
                return !1;
            const o = e.ownerDocument;
            return (t => {
                const e = F(t);
                return N(o = e) && l(o.dom.host) ? u.some(e) : u.none();
                var o
            })(R(e)).fold((() => o.body.contains(e)), (n = Y,
                r = K,
                t => n(r(t))));
            var n, r
        },
        ...
        Q = t => S("li")(t) && X(t).filter((t => "ul" === k(t) && I(t, "tox-checklist"))).isSome(),
        W = (t, e) => e < (t => {
            ...
            return (t => {
                ...
                return o === e ? H(o.offsetLeft, o.offsetTop) : Y(t) ? (t => {
        ...
        Z = t => ((t, e) => {
            const o = A(t) ? t.dom.classList.toggle(e) : ((t, e) => h(E(t), e) ? M(t, e) : D(t, e))(t, e);
            return B(t),
                o
        })(t, "tox-checklist--checked"),
        _ = t => h(["ul", "ol", "dl"], k(t)),
        tt = t => (u.from(t).filter((t => I(t, "tox-checklist"))).bind(z).map((t => {
                S("li")(t) && z(t).exists(S("ul")) && j(t, "tox-checklist--hidden")
            })),
            t);
    ...
    const ot = (t, e, o) => {
        ...
        rt = (t, e) => {
            ...
            var n, r;
            return r = o,
                (t => u.from(t.dom.nextSibling).map(R))(n = t).fold((() => {
                    X(n).each((t => {
                        nt(t, r)
                    }))
                }), (t => {
        ...
        st = (t, e, o) => ot(t, (t => q(t, e)), o),
        it = t => e => l(e) && t.test(e.nodeName),
        lt = it(/^(OL|UL|DL)$/),
        ct = it(/^(LI|DT|DD)$/),
        at = ["OL", "UL", "DL"],
        ut = at.join(","),
        dt = (t, e) => {
            const o = t.dom.getParents(e, t.dom.isBlock);
            return (n = o,
                r = e => {
                    return o = t.schema, !lt(n = e) && !ct(n) && ((t, e) => {
                        for (let e = 0, s = t.length; e < s; e++)
                            if (r = t[e],
                                o.isValidChild(n.nodeName, r))
                                return !0;
                        var r;
                        return !1
                    })(at);
                ...
                ((t, e, o) => {
                    ...
                    return u.none()
                })(n, r, d)).getOr(t.getBody());
            var n, r
        },
        mt = t => {
            const e = t => "ol" === k(t) || "ul" === k(t),
                o = () => {
                    const o = R(t.selection.getNode());
                    var n, r;
                    t.selection.isEditable() && (n = o,
                        r = e,
                        et(((t, e) => e(t)), ot, n, r, undefined)).fold((() => {
                        t.undoManager.transact((() => {
                            t.execCommand("InsertUnorderedList", !1, {
                                ...
                                f(p(g(t.selection.getSelectedBlocks(), R), e), (t => j(t, "tox-checklist")))
                        }))
                    }), (e => {
                        t.undoManager.transact((() => {
                            if (I(e, "tox-checklist"))
                                ...
                                const o = t.selection.getBookmark(),
                                    n = (t => {
                                        const e = ((t, e) => {
                                                ...
                                                return t.dom.getParent(o, ut, dt(t, o))
                                            })(t),
                                            o = t.selection.getSelectedBlocks();
                                        return ((t, e) => l(t) && 1 === e.length && e[0] === t)(e, o) ? (t => p(t.querySelectorAll(ut), lt))(e) : p(o, (t => lt(t) && e !== t))
                                    })(t).map(R);
                                f([e, ...n], (t => {
                                        const e = rt(t, "ul");
                                        j(e, "tox-checklist")
            ...
            t.ui.registry.addToggleButton("checklist", {
                    ...
                    onSetup: o => {
                        const n = R(t.getBody()),
                            ...
                            s = e => o.setActive(!t.readonly && ((t, e, o) => et(((t, e) => q(t, e)), st, t, ".tox-checklist", o))(R(e), 0, r).isSome()),
                            i = () => {
